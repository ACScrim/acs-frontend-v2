...
var challongeService = {
     ...
     */
    createBracket: function (tournamentId, settings) { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api_1.default.post("/admin/tournaments/".concat(tournamentId, "/challonge/create"), settings || {})];
                case 1:
                    response = _a.sent();
...
exports.default = challongeService;
