...
const table = useVueTable({
  ...
  columns: [
    ...
    { header: 'Dernière activité', accessorKey: 'transactions', cell: info => `${info.getValue()[info.getValue().length-1].amount} | ${info.getValue()[info.getValue().length-1].description}` },
