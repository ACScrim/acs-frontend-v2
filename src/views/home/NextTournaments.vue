        ...
        <div class="flex flex-col">
          <div class="relative">
            <img
              ...
              class="cover w-full h-50 aspect-video"
            />
            <Badge
              class="uppercase ml-auto absolute bottom-0 right-0 font-bold h-auto text-lg! bg-vibrant-purple-500 rounded-none rounded-tl-xl"
              >{{ formatDate(new Date(tournament.date), "dddd") }}</Badge
            >
          </div>
          <div class="space-y-4 p-2">
            ...
            <ul class="flex flex-col">
              <li class="inline-flex gap-2 items-center">
                <VueIcon name="ak:calendar" /><span>{{
                  formatDate(new Date(tournament.date), "DD/MM/YYYY HH:mm")
                }}</span>
              </li>
              <li class="inline-flex gap-2 items-center">
                <VueIcon name="cl:users-group" />{{
