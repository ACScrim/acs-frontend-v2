...
const adminRoutes: RouterOptions['routes'] = [
  ...
  { path: '/admin/users', component: () => import('@/views/admin/users/Users.vue'), name: 'Gestion des utilisateurs', meta: { title: 'Users', icon: 'bx:user', showInAside: false, showInMobileFooter: false, showInAdminBar: (user: User) => user.role === "superadmin", order: 1 } },
  ...
  { path: '/admin/cards/:cardId/edit', component: () => import('@/views/games/card-creator/CardCreator.vue'), name: 'AdminCardEdit', meta: { title: 'Édition de carte', icon: 'ch:cards', showInAside: false, showInMobileFooter: false, showInAdminBar: false } },
