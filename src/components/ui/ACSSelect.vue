...
<template>
  <select 
    ...
    class="flex-1 md:w-auto bg-gradient-to-r bg-surface-700/60 border border-white/10 text-foam-50 rounded-lg pl-4 pr-8 py-2 font-semibold hover:border-accent-300 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-accent-300/40 shadow-lg hover:shadow-xl hover:shadow-accent-300/20"
    :class="customClass"
    v-tw-merge
  >
