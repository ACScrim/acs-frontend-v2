...
<template>
  <div class="border-christmas-gold border-2 rounded-lg overflow-hidden flex flex-col gap-4 pb-4">
    ...
    <div class="flex items-center justify-center gap-2 mt-8" v-if="paginated">
