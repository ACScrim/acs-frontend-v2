...
<template>
  ...
  <footer class="lg:hidden fixed bottom-0 left-0 right-0 flex flex-row items-center h-20 bg-gradient-to-r from-christmas-navy/95 via-christmas-midnight/95 to-christmas-navy/95 backdrop-blur-md border-t-2 border-christmas-gold/40 shadow-lg shadow-christmas-gold/20 z-50">
