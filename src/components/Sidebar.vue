...
<template>
  <aside class="flex flex-1 flex-col items-center p-8 before:p-8 gap-4 rounded-xl before:rounded-xl m-4 before:m-4 before:shadow-acs-card before:shadow-black">
