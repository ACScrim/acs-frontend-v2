<template>
    <aside class="flex-1 flex flex-col items-center p-4 m-8 gap-4 bg-transparent rounded-xl">
      ...
      <RouterLink v-for="route in asideRoutes" :key="route.path" :to="route.path"
        class="text-white border-2 border-transparent hover:bg-vibrant-purple-500 hover:border-vibrant-purple-700 hover:shadow-[5px_5px_0_var(--color-vibrant-purple-700)] rounded-md flex flex-row gap-4 w-full p-2"
